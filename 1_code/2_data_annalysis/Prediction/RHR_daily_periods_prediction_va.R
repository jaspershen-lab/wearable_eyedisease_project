...
features_for_imputation <- model_data_clean %>%
  dplyr::select(
    ...
    age, gender, cataract_2, dm_2, hypertension_2,
    # # OCTA features
    retina_vars,
    # Target variable
    vision_improvement
...
#交叉验证，参数解释见下文
# Convert x to a matrix if it's a data frame
...
# 选择LASSO筛选出的特征
selected_features <- c(
  "rhr_mean_1", "rhr_min_1", "rhr_max_1", 
  "deep_sleep", "dream_sleep", "awake",
  "max_sleep_duration", "steps_total", "age",
  "dm_2", "PC1", "PC2", "PC4"
)
