...
# 设置工作路径
input_dir <- "3_data_analysis/3_prediction_modeling/1w_prediction/time_period_data_grouped/dm_group"
output_dir <- "3_data_analysis/3_prediction_modeling/1w_prediction/time_period_data_grouped/dm_group/lmm_model_performance"
...
p_d 
ggsave(file.path(output_dir, "predictor_performance_by_period_d.pdf"), p_d , width = 10, height = 6)
# 非糖尿病组
...
p_nod 
ggsave(file.path(output_dir, "predictor_performance_by_period_nd.pdf"), p_nod , width = 10, height = 6)
