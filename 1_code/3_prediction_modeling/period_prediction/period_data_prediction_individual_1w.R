...
day_prior_1 <- read_csv("3_data_analysis/3_prediction_modeling/1w_prediction/time_period_data/pre_3d_data.csv")
...
features_for_imputation <- day_prior_1 %>%
  dplyr::select(
    # RHR features
    pre_surgery_3d_mean_rhr_steps_1, pre_surgery_3d_min_rhr_steps_1,pre_surgery_3d_max_rhr_steps_1,pre_surgery_3d_median_rhr_steps_1,pre_surgery_3d_sd_rhr_steps_1,pre_surgery_3d_iqr_rhr_steps_1,
    # BO features
    pre_surgery_3d_bo_mean,pre_surgery_3d_bo_min,pre_surgery_3d_bo_max,pre_surgery_3d_bo_median,pre_surgery_3d_bo_sd,pre_surgery_3d_bo_iqr,
    # # Sleep features
    pre_surgery_3d_deep_sleep_total, pre_surgery_3d_total_sleep_total,
    # awake, daytime_sleep,
    # Steps features
    pre_surgery_3d_steps_total,pre_surgery_3d_steps_mean,pre_surgery_3d_steps_max,
