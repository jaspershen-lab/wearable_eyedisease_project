...
analyze_time_window_data <- function(window_data, window_label) {
  ...
  feature_names <- setdiff(names(features_for_imputation), "vision_improvement_1m")
  ...
  model_data <- window_data_imputed[, c(lasso_selected_features, "vision_improvement_1m")]
...
for (window in time_windows) {
  ...
  # Count valid samples (non-NA vision_improvement_1m)
