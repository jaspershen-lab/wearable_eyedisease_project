...
# This script analyzes which day's data best predicts post-operative vision improvement
...
# 首先定义日期顺序
day_order <- c("Day -7", "Day -6", "Day -5", "Day -4", "Day -3", "Day -2", "Day -1", 
