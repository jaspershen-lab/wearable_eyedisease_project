...
dir.create("3_data_analysis/6_clustering_modeling/octa_analysis/all_metrics/1w/T2_T0", 
...
for (param in ppv_bloodflow_0_21$params) {
  ...
  # Save the plot
  ggsave(
    paste0("3_data_analysis/6_clustering_modeling/octa_analysis/all_metrics/1w/T2_T0/ppv_bloodflow_", 
...
for (param in cat_bloodflow_0_21$params) {
  ...
  # Save the plot
  ggsave(
    paste0("3_data_analysis/6_clustering_modeling/octa_analysis/all_metrics/1w/T2_T0/cat_bloodflow_", 
           gsub("_0_21_improvement", "", param), 
           ".pdf"),
    p,
    width = 10,
...
analyze_parameter_correlations <- function(data, param_cols, title, output_prefix) {
  ...
  pdf(
    paste0("3_data_analysis/6_clustering_modeling/octa_analysis/all_metrics/1w/T2_T0/", 
           output_prefix, 
...
ppv_sig_summary <- create_significant_summary(
  ppv_bloodflow_tests,
  ppv_bloodflow_0_21$params,
  "3_data_analysis/6_clustering_modeling/octa_analysis/all_metrics/1w/T2_T0/ppv_bloodflow_0_21_significant_results.csv"
)

cat_sig_summary <- create_significant_summary(
  cat_bloodflow_tests,
  cat_bloodflow_0_21$params,
  "3_data_analysis/6_clustering_modeling/octa_analysis/all_metrics/1w/T2_T0/cat_bloodflow_0_21_significant_results.csv"
)
...
write.csv(
  ppv_membership_corr,
  "3_data_analysis/6_clustering_modeling/octa_analysis/all_metrics/1w/T2_T0/ppv_membership_correlation_0_21.csv",
  row.names = FALSE
)

write.csv(
  cat_membership_corr,
  "3_data_analysis/6_clustering_modeling/octa_analysis/all_metrics/1w/T2_T0/cat_membership_correlation_0_21.csv",
  row.names = FALSE
)

#################
# Test differences for PPV thickness 0_21 parameters
ppv_thickness_tests <- test_cluster_differences(
  ppv_thickness_0_21$data,
  ppv_thickness_0_21$params
)

# Test differences for cataract thickness 0_21 parameters
cat_thickness_tests <- test_cluster_differences(
  cat_thickness_0_21$data,
  cat_thickness_0_21$params
)

# Create summary tables for thickness
ppv_thickness_sig_summary <- create_significant_summary(
  ppv_thickness_tests,
  ppv_thickness_0_21$params,
  "3_data_analysis/6_clustering_modeling/octa_analysis/all_metrics/1w/T2_T0/ppv_thickness_0_21_significant_results.csv"
)

cat_thickness_sig_summary <- create_significant_summary(
  cat_thickness_tests,
  cat_thickness_0_21$params,
  "3_data_analysis/6_clustering_modeling/octa_analysis/all_metrics/1w/T2_T0/cat_thickness_0_21_significant_results.csv"
)
...
write.csv(
  ...
  "3_data_analysis/6_clustering_modeling/octa_analysis/all_metrics/1w/T2_T0/ppv_thickness_membership_correlation_0_21.csv",
  row.names = FALSE
)

write.csv(
  cat_thickness_membership_corr,
  "3_data_analysis/6_clustering_modeling/octa_analysis/all_metrics/1w/T2_T0/cat_thickness_membership_correlation_0_21.csv",
  row.names = FALSE
)
