...
dir.create("3_data_analysis/6_clustering_modeling/vision_analysis/plots", 
...
ppv_sig_summary <- create_significant_summary(
  ppv_vision_tests,
  vision_params,
  "3_data_analysis/6_clustering_modeling/vision_analysis/ppv_vision_significant_results.csv"
)

cat_sig_summary <- create_significant_summary(
  cat_vision_tests,
  vision_params,
  "3_data_analysis/6_clustering_modeling/vision_analysis/cat_vision_significant_results.csv"
)
...
write.csv(
  ppv_membership_corr,
  "3_data_analysis/6_clustering_modeling/vision_analysis/ppv_membership_correlation_vision.csv",
  row.names = FALSE
)

write.csv(
  cat_membership_corr,
  "3_data_analysis/6_clustering_modeling/vision_analysis/cat_membership_correlation_vision.csv",
  row.names = FALSE
)
...
ppv_model <- build_logistic_model(
  ppv_vision_analysis,
  "3_data_analysis/6_clustering_modeling/vision_analysis/ppv"
)

cat_model <- build_logistic_model(
  cat_vision_analysis,
  "3_data_analysis/6_clustering_modeling/vision_analysis/cat"
)
...
saveRDS(ppv_vision_analysis, "3_data_analysis/6_clustering_modeling/vision_analysis/ppv_vision_analysis.rds")
saveRDS(cat_vision_analysis, "3_data_analysis/6_clustering_modeling/vision_analysis/cat_vision_analysis.rds")
saveRDS(all_vision_analysis, "3_data_analysis/6_clustering_modeling/vision_analysis/all_vision_analysis.rds")
